...
export default function BorrowerLoanApplicationForm({
  ...
  return (
    <div className="loan-print-form space-y-6 text-slate-900">
      <section className="loan-print-page page-1 space-y-6">
        <header className="loan-print-header space-y-2">
          ...
          <div className="maker-selfie-box">
            {makerSelfieUrl ? (
              <Image
                src={makerSelfieUrl}
                alt="Maker selfie"
                ...
                height={120}
                unoptimized
                className="h-[120px] w-[120px] rounded-lg border border-slate-300 object-cover"
              />
            ) : (
              <div className="flex h-[120px] w-[120px] items-center justify-center rounded-lg border border-slate-300 bg-slate-50 text-[10px] uppercase tracking-[0.2em] text-slate-400">
                No selfie
              </div>
            )}
          </div>
      ...
      <section className="loan-print-page page-2 space-y-6">
        <section className="space-y-4">
